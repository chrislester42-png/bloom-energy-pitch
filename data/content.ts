...
export const thesis = {
  ...
  bear: [
    ...
    "Of the \"$20B of future business,\" only about $0.5B is firm signed orders, the rest are plans and frameworks. And the 10-Q gives two answers on how independent last quarter's buyers were: $2.8M of related-party revenue in one note, a related-party customer at 21% in another.",
...
export const theCall = {
  ...
  conclusion:
    "Great company, demanding price. How much you'd own comes down to two beliefs: how much of the ~$20B pipeline becomes real orders, and whether Q2's \"independent customers took over\" story holds up, which the 10-Q left unresolved: $2.8M of related-party revenue in one note, a related-party customer at 21% in another. We land where we started, own the turnaround, respect the price, and after Q2 tripped two of our own tripwires, we've re-run our numbers in public rather than defending them.",
