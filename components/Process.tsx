...
const FLAGS = [
  { flag: "Two-sided call under formal review (triggered by the Q2 2026 print)", status: "RE-RUN COMPLETE, call unchanged in direction. Falsifiers 1 and 2 triggered on Jul 28 (see Scorecard: 2 of 8 inside our pre-registered ranges, every miss bullish). Per the rule fixed in advance the model was re-run on the raised guidance rather than defended: v9 anchors FY2026 to the $4.05B midpoint, rolls the net-debt bridge to the Q2 balance sheet, and moves blended value from $18.23 to $21.59. We did not raise the margin driver on a one-time tariff recovery. The two-sided call stands, at a higher trigger." },
  { flag: "Related-party revenue: substance vs classification", status: "OPEN, and the 10-Q widened the question rather than closing it. Note 11 reports $2,818k of related-party revenue for Q2. Note 1's concentration disclosure reports two customers at 44% and 21% of revenue and identifies the 21% one as the related party, roughly $224M. The definitions differ (Note 1 counts the contractual counterparty, which it states may be a project-finance affiliate rather than the end user), but the receivable side ties between the two notes: 17% of $458.1M in AR against Note 11's $76,092k balance. The earnings call supplied the mechanism (the CFO confirmed the financing layer rotated to IDF, with Oaktree/MUFG/Morgan Stanley), which explains a rotation but not a 79x gap. Next action: reconcile the two notes on the Q3 filing, and ask IR which lens governs the revenue line." },
  { flag: "Customer concentration (new, Q2 2026)", status: "OPEN. One customer, not a related party, was ~73% of H1 2026 revenue; inside Q2, two customers were 44% and 21%. Bloom does not name them. Not disclosed at this magnitude before, and not yet priced into our scenario spread. Next action: size a downside case on a single-customer schedule slip." },
